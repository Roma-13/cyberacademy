      ...
      <div className={styles.productCard}>
        <div className={styles.productTopSection}>
          <div className={styles.productHeader}>
            <h2 className={styles.productTitle}>პროგრამირების საფუძვლები და ალგორითმები</h2>
...
კურსი მოიცავს რამდენიმე მიმართულებას:
          ...
          <div className={styles.productDeliveryInfo}>
            ...
            <p>ხელმისაწვდომი ადგილები-30</p>
              ...
              <p>ალგორითმები </p>
              <p>მონაცემთა სტრუქტურები</p>
              <p>დაპროგრამების საფუძვლები C++-ის ბაზაზე</p>
              <p>C++-ის საშუალებით სასწავლო და მინი პროექტების შექმნა.</p>
