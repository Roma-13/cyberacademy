      ...
      <div className={styles.productCard}>
        <div className={styles.productTopSection}>
          <div className={styles.productHeader}>
            <h2 className={styles.productTitle}>გრაფიკული დიზაინი</h2>
          ...
          <div className={styles.productDeliveryInfo}>
            ...
            <p>კურსის ხანგძლივობა - 3 თვე</p>
              ...
              <p>რასტრული გრაფიკა პროგრამა Adobe Photoshop-ის ბაზაზე</p>
        ...
        <div className={styles.productImageContainer}>
          ...
          <span className={styles.mentorTag}>მიხეილ დონაძე</span>
        </div>
      </div>
