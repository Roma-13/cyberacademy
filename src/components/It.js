      ...
      <div className={styles.productCard}>
        <div className={styles.productTopSection}>
          <div className={styles.productHeader}>
            <h2 className={styles.productTitle}>IT სპეციალისტი</h2>
          ...
          <div className={styles.productDeliveryInfo}>
            ...
            <div className={styles.deliveryInfo}>
              ...
              <p>კომპიუტერული ქსელების აპარატურული და პროგრამული უზრუნველყოფა</p>
              <p>დარგობრივი ინგლისური ენა</p>
              <p>მნიშვნელოვანი საფუძველი მომავალი განვითარებისთვის</p>
              <p>პრაქტიკული გამოცდილება</p>
        ...
        <div className={styles.productImageContainer}>
          ...
          <span className={styles.mentorTag}>დემიდ ფასიეშვილი</span>
        </div>
      </div>
