...
import courseImage from "../asets/course-3.jpg"; // Adjust the path as needed
      ...
      <div className={styles.productCard}>
        <div className={styles.productTopSection}>
          <div className={styles.productHeader}>
            <h2 className={styles.productTitle}>ვებ ტექნოლოგიები</h2>
            <div className={styles.productDescription}>
            კიბერ აკადემია გთავაზობთ შესაძლებლობას შეისწავლოთ დღეისთვის სწრაფად განვითარებადი დარგი ვებ გვერდების.
          ...
          <div className={styles.productDeliveryInfo}>
            ...
            <p>კურსის ხანგძლივობა - 3 თვე</p>
              ...
              <p>JavaScript – სცენარული დაპროგრამების ენა</p>
              <p>Hosting/FTP – სერვერთან მუშაობა</p>
              <p>გრაფიკულ ობიექტებთან მუშაობა</p>
              <p>კონტენტის მართვის სისტემები WordPress-ის ბაზაზე</p>
        ...
        <div className={styles.productImageContainer}>
          ...
          <span className={styles.mentorTag}>კახი კახიძე</span>
        </div>
      </div>
