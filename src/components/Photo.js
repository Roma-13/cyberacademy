      ...
      <div className={styles.productCard}>
        <div className={styles.productTopSection}>
          <div className={styles.productHeader}>
            <h2 className={styles.productTitle}>ფოტოგრაფია, ფოტოჟურნალისტიკა, ფოტოგრაფია მარკეტინგში</h2>
          ...
          <div className={styles.productDeliveryInfo}>
            ...
            <p>კურსის ხანგძლივობა - 3 თვე</p>
              <p>ფოტოგრაფია მარკეტინგში</p>
              <p>   ფოტოგრაფიის აპარატურა და მისი შერჩევის თავისებურებები</p>
              <p>ფოტოს რეჟიმები</p>
              <p>სწორი რაკურსის შერჩევა
              </p>
              <p>ფოტოს თემატიკები და რასტრული გრაფიკა
</p>
              <p>ფოტოჟურნალისტიკა
              </p>
        ...
        <div className={styles.productImageContainer}>
          ...
          <span className={styles.mentorTag}>გიორგი კალანდაძე</span>
        </div>
      </div>
